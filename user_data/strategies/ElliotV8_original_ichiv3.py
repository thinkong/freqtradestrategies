...
class ElliotV8_original_ichiv3(IStrategy):
    ...
    def custom_stake_amount(self, pair: str, current_time: datetime, current_rate: float,
                    ...
                    **kwargs) -> float:
        if self.wife_mode == True and self.config['runmode'].value in ('live', 'dry_run'):
            if self.wallets.get_total_stake_amount() < 300 : #set this to minimum capital you want to have in your wallet
                # if wallet is under 6660 USDT stop trading
                return 0
            else:
